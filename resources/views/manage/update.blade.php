          ...
          <div class="card">
            <div class="card-body bg-light">
              <div class="form-group">
                ...
                <select id="nric" class="form-control" name="nric">
                </select>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input id="other" type="text" class="form-control" name="race" placeholder="Enter race here..." style="display:none;" required>
              </div>
              <div class="form-group">
            ...
            <div class="card-footer">
              <div class="form-group">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" id="is_check">
                  <label for="name"><strong>Driving License</strong></label>
                </div>
              ...
              <div class="form-group">
                <label for="name"><strong>Exipiry Date</strong></label>
                <input type="date" class="form-control license" name="dob" min="1940-01-01" max="2030-12-31">
              </div>
            </div>
          </div>
          <div class="col-md-12">
